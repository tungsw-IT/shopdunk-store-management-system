...
// Lấy tất cả biến thể thuộc dòng iPhone 16
...
<head>
    <meta charset="UTF-8">
    <title>iPhone 16 - Sản phẩm</title>
...
<nav class="filter-bar">
    ...
    <a href="iphone16.php" class="tab active">iPhone 16</a>
...
<form method="GET" class="filter-sort-form">
  ...
  <button type="button" onclick="window.location.href='iphone16.php'" style="background-color: #888; color: white; padding: 6px 14px; border: none; border-radius: 5px; cursor: pointer;">Reload</button>
</div>
</form>

<!-- Danh sách sản phẩm iPhone 16 -->
