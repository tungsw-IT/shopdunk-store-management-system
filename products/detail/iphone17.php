...
// Hàm hiển thị sao (FontAwesome) theo rating 
...
// Lấy tất cả biến thể thuộc dòng iPhone 17
...
<head>
    <meta charset="UTF-8">
    <title>iPhone 17 - Sản phẩm</title>
...
<nav class="filter-bar">
    ...
    <a href="iphone14.php" class="tab">iPhone 14</a>
    <a href="iphone15.php" class="tab">iPhone 15</a>
    <a href="iphone16.php" class="tab">iPhone 16</a>
    <a href="iphone17.php" class="tab active">iPhone 17</a>
</nav>
...
<form method="GET" class="filter-sort-form">
  ...
  <button type="button" onclick="window.location.href='iphone17.php'" style="background-color: #888; color: white; padding: 6px 14px; border: none; border-radius: 5px; cursor: pointer;">Reload</button>
</div>
</form>

<!-- Danh sách sản phẩm iPhone 17 -->
...
foreach ($displayedProducts as $product):
   ...
   $fallbackPath = '../../images/' . $imgName;
   if (!is_file(__DIR__ . DIRECTORY_SEPARATOR . str_replace('/', DIRECTORY_SEPARATOR, $fallbackPath))) {
       $fallbackPath = '';
   }
   $imagePath = resolve_primary_product_image_pdo($pdo, $product, $fallbackPath);
...
?>
 <div class="product-card hover-hand" style="position:relative;">
    ...
    <a href="product-detail-iphone.php?model_no=<?= $slug ?>" class="product-card-link">
                ...
                <?php else: ?>
                    <div style="height:220px;display:flex;align-items:center;justify-content:center;color:#64748b;">Chưa có ảnh</div>
                <?php endif; ?>
