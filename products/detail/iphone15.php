...
// Hàm hiển thị các icon sao (dựa vào điểm đánh giá trung bình)
...
// Lấy rating trung bình cho các sản phẩm iPhone 15
...
$displayedProducts = $filtered; // Kết quả cuối cùng sẽ show
?>
...
<head>
    <meta charset="UTF-8">
    <title>iPhone 15 - Sản phẩm</title>
...
<form method="GET" class="filter-sort-form">
  ...
  <button type="button" onclick="window.location.href='iphone15.php'" style="background-color: #888; color: white; padding: 6px 14px; border: none; border-radius: 5px; cursor: pointer;">Reload</button>
</div>
</form>
...
// Lặp qua từng sản phẩm và render ra card
